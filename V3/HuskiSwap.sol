...
contract HuskiSwap
{
    ...
    function buyHSKI(uint256 minHski) external payable returns (bool)
    {
        ...
        //taxExclusions[uniswapV2Pair] = true;

        _swapBNBforHSKI(value, minHski, sender);

        //taxExclusions[uniswapV2Pair] = false;
    ...
    function addLiquidity(uint256 hskiAmount, uint256 minHski, uint256 minBnb) external payable returns (uint256, uint256, uint256)
    {
        ...
        //_rawTransfer(sender, address(this), hskiAmount);
        _hski.taxFreeTransfer(sender, address(this), hskiAmount);
        ...
        //Return unused HSKI
        //_rawTransfer(address(this), sender, hskiAmount - hskiSent);
        _hski.taxFreeTransfer(address(this), sender, hskiAmount - hskiSent);
    ...
    function removeLiquidity(uint256 lpTokens, uint256 minHski, uint256 minBnb) external returns (uint256, uint256)
    {
        ...
        //taxExclusions[SWAP_ROUTER] = true;
        ...
        //taxExclusions[SWAP_ROUTER] = false;
    ...
    function lockLiquidity() public
    {
        ...
        //_rawTransfer(_swapReceiver, address(this), hskiAmount);
        _hski.taxFreeTransfer(_swapReceiver, address(this), hskiAmount);
